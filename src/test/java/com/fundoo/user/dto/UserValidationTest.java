...
public class UserValidationTest {
    ...
    public void GivenInvalidName_whenValidation_ItShouldNotAccept() {
        RegisterUserDto registerUserDto = new RegisterUserDto("", "waghmare", "kajalw1998@gmail.com", "Asha#ghf","Mumbai");
    ...
    public void GivenInvalidEmail_whenValidation_ItShouldNotAccept() {
        RegisterUserDto registerUserDto = new RegisterUserDto("kajal", "waghmare", "kajalw199gmail.com", "Asha#ghf","Mumbai");
        Set<ConstraintViolation<RegisterUserDto>> validate = validator.validate(registerUserDto);
    ...
    public void GivenInvalidPassword_whenValidation_ItShouldNotAccept() {
        RegisterUserDto registerUserDto = new RegisterUserDto("kajal", "waghmare", "kajalw199@gmail.com", "as23","Mumbai");
        Set<ConstraintViolation<RegisterUserDto>> validate = validator.validate(registerUserDto);
