...
public class NoteServiceTest {
    ...
    void setUp() {
        ...
        noteDto = new NoteDto(4, "java", "this is desciption", "#e6c9a8", false, false, null, null, null);
...
//    @Test
//    void givenTitleAndDesciption_whenCreatingNote_ItShouldreturnNoteData() throws IOException, NoteException, MessagingException {
...
//    }
    ...
    void givenNoteId_WhenUpdateNote_ItShouldReturnUpdateNote() throws NoteException {
        NoteDto noteDto = new NoteDto(4, "java", "this is desciption", "#e6c9a8", false, false, null, null, null);
    ...
    void givenSortValueAndType_WhenSorting_ItShouldReturnSortedData() {
        ...
        Note note1 = new Note();
        Note note2 = new Note();
        NoteDto noteDto1 = new NoteDto(4, "va", "this is description", "#e6c9a8", false, false, null, null, null);
        NoteDto noteDto2 = new NoteDto(4, "spring", "this is description", "#e6c9a8", false, false, null, null, null);
    ...
    void givenReminder_WhenSetReminderItShouldReturnTrue() throws NoteException {
        String time = "2020-11-19T18:30:00.000Z";
    ...
    void givenReminder_WhenDeleteReminderItShouldReturnTrue() throws NoteException {
        String time = "2020-11-19T18:30:00.000Z";
        when(noteRepository.findById(anyInt())).thenReturn(Optional.of(note));
        boolean result = noteService.deleteReminder(4, "kdw@gmail.com");
        Assert.assertEquals(result, true);
    ...
    void whenGetReminderNotes_ItShouldReturnNotes() {
        ...
        Assert.assertEquals(reminderSetNotes.get(0).getRemainder(), time);
    }
